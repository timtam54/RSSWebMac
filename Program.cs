...
//builder.Services.AddDbContext<dbcontext>(options => options.UseSqlServer("Server=.;Initial Catalog=RoofSafetySolutions;Integrated Security=true;Connection Timeout=30;"));
